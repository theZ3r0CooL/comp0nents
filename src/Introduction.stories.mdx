...
<Meta title="Introduction to comp0nents" />
...
<img src={Icon} alt='comp0nents'/>
<h3>A Library of Beautiful React Components.</h3>
...
[![Storybook](https://cdn.jsdelivr.net/gh/storybookjs/brand@main/badge/badge-storybook.svg)](/story/introduction-to-comp0nents--page)
...
Just a few styled **Components** for convenience and inspiration.
View their code in `COMPONENTS` section of the sidebar to learn how they work.
Some helpful links and basic instructions are also provided below to help you start using [***comp0nents***](https://www.github.com/theZ3r0CooL/comp0nents#readme) in your project as soon as possible.

<div className="subheading">Components</div>
<div className="link-list">
    <a className="link-item" href="/story/components-styledbutton--default">
        <img src={Plugin} alt="plugin" />
        <span>
      <strong>StyledButton</strong>
      Ready to use <code>button</code> element with styling included.
    </span>
    </a>
